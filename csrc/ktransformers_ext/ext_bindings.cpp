...
public:
  ...
  public:
    ...
    static std::pair<intptr_t, intptr_t> cpuinfer_interface(
        KVCache &kv_cache, intptr_t q_in, intptr_t output, intptr_t attn_lse,
  ...
  public:
    ...
    static void inner(void *args) {
      ...
      args_->cpuinfer->enqueue(&KVCache::get_all_kvcache_one_layer,
                               args_->kv_cache, args_->layer_id, args_->k_in,
                               args_->v_in);
    }
    static std::pair<intptr_t, intptr_t> cpuinfer_interface(KVCache &kv_cache,
                                                            intptr_t k_in,
                                                            intptr_t v_in,
                                                            int layer_id) {
      Args *args = new Args{nullptr, &kv_cache, layer_id, (ggml_fp16_t *)k_in,
                            (ggml_fp16_t *)v_in};
      return std::make_pair((intptr_t)&inner, (intptr_t)args);
    }
  };
  ...
  public:
    ...
    static void inner(void *args) {
      Args *args_ = (Args *)args;
      args_->cpuinfer->enqueue(
          &KVCache::get_and_update_kvcache_fp16, args_->kv_cache, args_->k_in,
          args_->v_in, args_->layer_id, args_->block_table, args_->batch_size,
          args_->max_block_num, args_->cache_seqlens, args_->q_len);
    }
  ...
  public:
    ...
    static void inner(void *args) {
      Args *args_ = (Args *)args;
      args_->cpuinfer->enqueue(&KVCache::get_kvcache_fp16, args_->kv_cache,
                               args_->k_in, args_->v_in, args_->layer_id,
                               args_->block_table, args_->batch_size,
                               args_->max_block_num, args_->cache_seqlens);
    }
    static std::pair<intptr_t, intptr_t>
    cpuinfer_interface(KVCache &kv_cache, intptr_t k_in, intptr_t v_in,
                       int layer_id, intptr_t block_table, int batch_size,
  ...
  public:
    ...
    static void inner(void *args) {
      Args *args_ = (Args *)args;
      args_->cpuinfer->enqueue(
          &KVCache::update_kvcache_fp16, args_->kv_cache, args_->k_in,
          args_->v_in, args_->layer_id, args_->block_table, args_->batch_size,
          args_->max_block_num, args_->cache_seqlens, args_->q_len);
    }
    static std::pair<intptr_t, intptr_t>
  ...
  public:
    ...
    cpuinfer_interface(KVCache &kv_cache, intptr_t importance, int layer_id,
      ...
      Args *args = new Args{
          nullptr,       &kv_cache,          (const ggml_fp16_t *)importance,
  ...
  public:
    ...
    cpuinfer_interface(KVCache &kv_cache, intptr_t block_table,
                       ...
                       int max_block_num) {
      Args *args = new Args{
          nullptr,    &kv_cache,    (int *)block_table, (int *)cache_seqlens,
  ...
  public:
    ...
    static void inner(void *args) {
      Args *args_ = (Args *)args;
      args_->cpuinfer->enqueue(
          &KVCache::calc_anchor_all_layers, args_->kv_cache, args_->block_table,
  ...
  public:
    ...
    cpuinfer_interface(KVCache &kv_cache, intptr_t block_table,
      ...
      Args *args = new Args{nullptr, &kv_cache, (int *)block_table,
...
public:
  ...
  public:
    ...
    static void inner(void *args) {
      Args *args_ = (Args *)args;
      args_->cpuinfer->enqueue(&Linear::forward, args_->linear, args_->qlen,
    ...
    static std::pair<intptr_t, intptr_t> cpuinfer_interface(Linear &linear,
                                                            ...
                                                            intptr_t output) {
      Args *args =
          new Args{nullptr, &linear, qlen, (const void *)input, (void *)output};
      return std::make_pair((intptr_t)&inner, (intptr_t)args);
    }
  };
};
...
public:
  ...
  public:
    ...
    static std::pair<intptr_t, intptr_t>
    cpuinfer_interface(MLP &mlp, int qlen, intptr_t input, intptr_t output) {
      Args *args =
          new Args{nullptr, &mlp, qlen, (const void *)input, (void *)output};
      return std::make_pair((intptr_t)&inner, (intptr_t)args);
    }
  };
};
...
public:
  ...
  public:
    ...
    static void inner(void *args) {
      Args *args_ = (Args *)args;
      args_->cpuinfer->enqueue(&MOE::forward, args_->moe, args_->qlen, args_->k,
                               args_->expert_ids, args_->weights, args_->input,
                               args_->output, args_->batch_size_tensor);
    }
    static std::pair<intptr_t, intptr_t>
...
#if defined(__x86_64__) && defined(__HAS_AVX512F__) && defined(__HAS_AMX__)
template <class T> class AMX_MOEBindings {
public:
  ...
  // Add new binding for load_weights_int8 function
  class LoadWeightsInt8Bindings {
  public:
    struct Args {
      CPUInfer *cpuinfer;
      AMX_MOE<T> *moe;
    ...
    static void inner(void *args) {
      Args *args_ = (Args *)args;
      args_->cpuinfer->enqueue(&AMX_MOE<T>::load_weights_int8, args_->moe);
    }
    static std::pair<intptr_t, intptr_t> cpuinfer_interface(AMX_MOE<T> &moe) {
      Args *args = new Args{nullptr, &moe};
      return std::make_pair((intptr_t)&inner, (intptr_t)args);
  ...
  public:
    ...
    static void inner(void *args) {
      Args *args_ = (Args *)args;
      args_->cpuinfer->enqueue(&AMX_MOE<T>::forward, args_->moe, args_->qlen,
                               args_->k, args_->expert_ids, args_->weights,
                               args_->input, args_->output,
...
PYBIND11_MODULE(cpuinfer_ext, m) {
  ...
  py::class_<LinearConfig>(linear_module, "LinearConfig")
      .def(py::init([](int hidden_size, int intermediate_size, int stride,
        ...
        return LinearConfig(hidden_size, intermediate_size, stride,
                            group_max_len, (void *)proj, (ggml_type)proj_type,
  ...
  py::class_<MLPConfig>(mlp_module, "MLPConfig")
      .def(py::init([](int hidden_size, int intermediate_size, int stride,
        ...
        return MLPConfig(hidden_size, intermediate_size, stride, group_max_len,
  ...
  py::class_<KVCache>(kvcache_module, "KVCache")
      ...
      .def(
          ...
          &KVCacheBindings::GetAndUpdateKVCacheFp16Bindings::cpuinfer_interface)
